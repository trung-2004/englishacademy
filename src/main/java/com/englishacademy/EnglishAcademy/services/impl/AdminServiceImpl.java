...
public class AdminServiceImpl implements AdminService {
    ...
    public List<Menu> getMenu(User currenUser) {
        ...
        if (roles.contains(Role.ADMIN)) {
            ...
            menuItems3.add(new MenuItem("Student", "/student", "fas fa-user-graduate"));
            menuItems4.add(new MenuItem("Profile", "/profile", "fas fa-user-shield"));
            menus.add(new Menu("Dashboard", menuItems1));
            menus.add(new Menu("Potential Customers", menuItems2));
            menus.add(new Menu("Student", menuItems3));
            menus.add(new Menu("Information", menuItems4));
        }
        return menus;
    }
